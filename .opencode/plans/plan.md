...
```
┌─────────────────────────────────────────────┐
│  Header: Job ID | Confidence | PDF names    │
├──────────────────────┬──────────────────────┤
│  Fields Table        │  Page Image          │
│  ┌────────────────┐  │  ┌────────────────┐  │
│  │ PDF │ Label   │  │  │   Page preview  │  │
│  │ f1  │ Name    │  │  │   (responsive)  │  │
│  │ f1  │ Date    │  │  │                │  │
│  │ f2  │ Address │  │  │                │  │
│  └────────────────┘  │  └────────────────┘  │
...
- Click a field row → page image jumps to that page
- Page arrows navigate images
- Filter fields by PDF source via dropdown
- lastJobId stored in localStorage for session return
